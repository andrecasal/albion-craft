...
import { fetchDemandSupplyData, DemandSupplyData } from './services/market-data-fetcher';
...
// Get data freshness indicator for market data
...
async function showMenu(): Promise<string> {
  ...
  return new Promise((resolve) => {
    ...
    console.log('========================================');
    console.log(`1. Refresh market data ${marketDataFreshness}`);
    console.log('2. View high demand / low supply items');
    console.log('3. Craft from inventory');
    console.log('4. Craft from market (buy materials)');
    console.log('5. Material buy opportunities');
    console.log('6. City arbitrage scanner');
    console.log('7. Exit');
    console.log('----------------------------------------');
...
// Refresh all market data (material prices + demand/supply + market prices)
